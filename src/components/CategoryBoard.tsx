    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {categories.map(cat => (
          ...
          >
            <Folder size={32} className="text-slate-500 group-hover:text-primary transition-colors" />
            <div>
        ...
        >
          <Folder size={32} className="text-slate-600 group-hover:text-slate-400 transition-colors" />
          <div>
